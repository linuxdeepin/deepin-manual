...
"false")return!1;c.append('<div class="slider-nav"><span id="Right" class="right" onMouseOver="this.className=\'right0\';document.getElementById(\'Left\').className=\'left0\'" onMouseOut="this.className=\'right\';document.getElementById(\'Left\').className=\'left\'">Right</span><span class="left" id="Left" onMouseOver="this.className=\'left0\';document.getElementById(\'Right\').className=\'right0\'" onMouseOut="this.className=\'left\';document.getElementById(\'Right\').className=\'right\'">Left</span></div>');var k=c.children("div.slider-nav").children("span.left"),w=c.children("div.slider-nav").children("span.right");k.click(function(){n();l("prev")});w.click(function(){n();l("next")})}if(a.bullets){c.append('<ul class="orbit-bullets"></ul>');var C=c.children("ul.orbit-bullets");for(i=0;i<p;i++){k=d("<li>"+(i+1)+"</li>");if(a.bulletThumbs&&(w=e.eq(i).data("thumb")))k=d('<li class="has-thumb">'+
