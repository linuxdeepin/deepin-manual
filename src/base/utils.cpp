...
QString languageArr[][langCount] = {
    ...
    {"system", "系统", "System", "系統", "系統"},
    {"device", "蓝牙和其他设备", "Bluetooth and Devices", "藍牙和其他裝置", "藍牙和其他裝置"},
    ...
    {"accounts", "账户", "Accounts", "賬戶", "帳戶"},
    {"otherAccountSettings", "账户", "Accounts", "賬戶", "帳戶"},
    {"cloudsync", "Union ID", "Union ID", "Union ID", "Union ID"},
    {"display", "显示", "Display", "顯示", "顯示"},
    {"screenTitle", "显示", "Display", "顯示", "顯示"},
    {"displayColorTemperature", "显示", "Display", "顯示", "顯示"},
    {"eyeComfort", "显示", "Display", "顯示", "顯示"},
    {"defapp", "默认程序", "Default Programs", "預設程式", "預設程式"},
    {"defaultapp", "默认程序", "Default Programs", "預設程式", "預設程式"},
    {"personalization", "个性化", "Personalization", "個人化", "個人化"},
    {"themeRoot", "设置窗口主题", "Theme", "設定視窗主題", "設定視窗主題"},
    {"appearance", "外观", "Appearance", "外觀", "外觀"},
    {"dock", "桌面和任务栏", "Desktop & Taskbar", "桌面和工作列設定", "桌面和工作列設定"},
    {"pluginArea", "显示/隐藏插件", "Show/Hide Plugins", "顯示/隱藏外掛", "顯示/隱藏外掛"},
    {"windowEffect", "窗口效果", "Window Effects", "視窗效果", "視窗效果"},
    {"wallpaper", "壁纸", "Wallpaper", "桌布", "桌布"},
    {"screenSaver", "屏幕保护", "Screensaver", "螢幕保護", "螢幕保護程式"},
    {"colorAndIcons", "颜色和图标", "Colors & Icons", "顏色和圖示", "顏色和圖示"},
    {"font", "字体和字号", "Fonts & Sizes", "字型和字型大小", "字型和字型大小"},
    {"network", "网络", "Network Settings", "網路", "網路"},
    {"connectionSettings", "网络", "Network Settings", "網路", "網路"},
    {"wired", "有线网络", "Wired Network", "有線網路", "有線網路"},
    {"wireless", "无线网络", "Wireless Network", "無線網路", "無線網路"},
    {"wireless2", "无线网络", "Wireless Network", "無線網路", "無線網路"},
    {"personalHotspot", "个人热点", "Personal Hotspot", "個人熱點", "個人熱點"},
    {"airplaneMode", "飞行模式", "Airplane Mode", "飛航模式", "飛航模式"},
    {"networkVpn", "VPN", "VPN", "VPN", "VPN"},
    {"systemProxy", "系统代理", "System Proxy", "系統代理", "系統代理"},
    {"networkDetails", "网络详情", "Network Details", "網路詳情", "網路詳情"},
    {"dsl", "拨号网络", "DSL", "撥號網路", "撥號網路"},
    {"notification", "通知", "Notification", "通知", "通知"},
    {"doNotDisturbNotification", "通知", "Notification", "通知", "通知"},
    {"appNotify", "设置应用通知", "App Notifications", "設定應用通知", "設定應用程式通知"},
    {"sound", "声音", "Sound", "聲音", "聲音"},
    {"outPut", "输出设置", "Output Settings", "輸出設定", "輸出設定"},
    {"inPut", "输入设置", "Input Settings", "輸入設定", "輸入設定"},
    {"soundSettings", "声音", "Sound", "聲音", "聲音"},
    {"soundEffectsPage", "系统音效", "System Sounds", "系統音效", "系統音效"},
    {"deviceManager", "设备管理", "Device Management", "裝置管理", "裝置管理"},
    {"inputDevice", "设备管理", "Device Management", "裝置管理", "裝置管理"},
    {"bluetooth", "蓝牙", "Bluetooth", "藍牙", "藍牙"},
    {"datetime", "时间和日期", "Time & Date", "時間和日期", "時間和日期"},
    {"langAndFormat", "语言和区域", "Language & Region", "語言和區域", "語言和區域"},
    {"power", "电源管理", "Power", "電源管理", "電源管理"},
    {"general", "电源管理", "Power", "電源管理", "電源管理"},
    {"onPower", "电源管理", "Power", "電源管理", "電源管理"},
    {"onBattery", "电源管理", "Power", "電源管理", "電源管理"},
    {"powerPlansTitle", "调整性能模式", "Power", "電源管理", "電源管理"},
    {"powerSavingSettingsTitle", "设置节能模式", "Power Saving Settings", "電源管理", "電源管理"},
    {"wakeupSettingsTitle", "唤醒设置", "Power", "電源管理", "電源管理"},
    {"shutdownSettingTitle", "关机设置", "Power", "電源管理", "電源管理"},
    {"screenAndSuspendTitle", "设置显示器关闭时间", "Power", "電源管理", "電源管理"},
    {"lowBatteryTitle", "低电量管理", "Power", "電源管理", "電源管理"},
    {"batteryManagementTitle", "电池管理", "Power", "電源管理", "電源管理"},
    {"mouse", "鼠标和触控板", "Mouse and Touchpad", "滑鼠和觸控板", "滑鼠與觸控板"},
    {"MouseAndTouchpad", "鼠标和触控板", "Mouse and Touchpad", "滑鼠和觸控板", "滑鼠與觸控板"},
    {"MouseAndTouchpadCommon", "通用设置", "General Settings", "一般設定", "通用設定"},
    {"MouseAndTouchpadMouse", "鼠标设置", "Mouse Settings", "滑鼠設定", "滑鼠設定"},
    {"Touchpad", "触控板设置", "Touchpad Settings", "觸控板設定", "觸控板設定"},
    {"tablet", "数位板", "Graphics Tablet", "繪圖板", "數位板"},
    {"wacom", "数位板", "Graphics Tablet", "繪圖板", "數位板"},
    {"keyboard", "键盘", "Keyboard", "鍵盤", "鍵盤"},
    {"KeyboardCommon", "键盘属性", "Keyboard Properties", "鍵盤屬性", "鍵盤屬性"},
    {"Manage Input Methods", "输入法", "Input Methods", "輸入法", "輸入法"},
    {"shortcutSettingsView", "快捷键", "Shortcuts", "快捷鍵", "快捷鍵"},
    {"voice", "辅助功能", "Assistive Tools", "輔助功能", "輔助功能"},
    {"privacy", "隐私和安全", "Privacy and Security", "私隱和安全", "隱私和安全"},
    {"camera", "摄像头", "Camera", "攝像頭", "攝像頭"},
    {"filefolder", "文件和文件夹", "Files and Folders", "文件和文件夾", "文件和資料夾"},
    {"update", "系统更新", "System Updates", "系統更新", "系統更新"},
    {"updateSettingsPage", "更新设置", "Update Settings", "更新設定", "更新設定"},
    {"systeminfo", "关于本机", "About This PC", "關於本機", "關於本機"},
    {"systemInfo", "关于本机", "About This PC", "關於本機", "關於本機"},
    {"versionProtocol", "开源软件声明", "Open Source Software Notice", "開源軟體聲明", "開源軟體宣告"},
    {"userLicense", "最终用户许可协议", "End User License Agreement", "最終用戶授權協議", "最終使用者授權協議"},
    {"privacyPolicy", "隐私政策", "Privacy Policy", "私隱政策", "隱私政策"},
    {"bootMenu", "启动菜单", "Boot Menu", "開機選單", "開機選單"},
    {"developerMode", "开发者选项", "Developer Options", "開發者選項", "開發者選項"},
    {"udcp", "域管理", "Domain Management", "網域管理", "網域管理"},
    {"BackupAndRestore", "备份还原", "Backup & Restore", "備份還原", "備份還原"},
    {"Backup and Restore", "备份还原", "Backup & Restore", "備份還原", "備份還原"},
    {"License activator", "授权管理", "Authorization Management", "授權管理", "授權管理"},
    {"commoninfo", "通用设置", "General Settings", "一般設定", "一般設定"},
    {"common", "系统", "System", "系統", "系統"},
    {"touchscreen", "触控屏", "Touchscreen Settings", "觸控螢幕", "觸控螢幕"},
};
