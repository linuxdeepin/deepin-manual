...
QString languageArr[][langCount] = {
    //dde model
    {"system", "控制中心", "Control Center", "控制中心", "控制中心"},
    ...
    {"personalization", "个性化", "Personalization", "個人化設定", "個人化設定"},
    {"network", "网络", "Network", "網路", "網路"},
    {"notification", "通知", "Notification", "通知", "通知"},
    {"sound", "声音", "Sound", "聲音", "聲音"},
    {"bluetooth", "蓝牙", "Bluetooth", "藍牙設定", "藍芽設定"},
    {"datetime", "时间和日期", "Date and Time", "時間和日期", "時間和日期"},
