...
联系人是基于Deepin ID的联系人通讯管理软件，支持多人视频会议、屏幕共享等功能，可以极大的方便用户讨论沟通，提高效率。
...
1. 运行 **联系人** 应用后，将自动调用操作系统 **云同步登录** 界面。如果没有Deepin ID，可通过以下方式注册。

2. 点击 **注册** 超链接后，成功调用操作系统中的默认浏览器，并打开<https://account.deepinid.deepin.com/register?lang=zh-cn>页面。

   ![2register](jpg/2register.png)

3. 根据页面提示，输入相关信息进行Deepin ID注册。
...
2. 点击 **忘记密码？** 超链接后，成功调用操作系统中的默认浏览器，并打开<https://account.deepinid.deepin.com/register/support?lang=zh-cn>页面。
...
3. 输入Deepin ID和密码，验证通过后。同步完成联系人客户端登录，并跳转至联系人主界面。
...
2. 在搜索框中输入想要搜索的好友Deepin ID、好友昵称、好友备注、群名称，可以快速的找到联系人。

  > ![notes](icon/notes.svg) ：搜索对象与Deepin ID呈一定相关性，非陌生人对象。
