...
文件管理器是深度科技开发的一款功能强大、简单易用的文件管理工具。
...
您可以通过以下方式运行或关闭文件管理器，或者创建文件管理器的快捷方式。
...
3. 将鼠标指针置于文件管理器应用程序的图标上，右键单击 ![deepin-file-manager](icon/deepin-file-manager.svg)  图标，您可以：
 - 点击 **发送到桌面**，在桌面创建快捷方式。
...
- 在文件管理器界面点击  ![close_icon](icon/close_icon.svg) ，退出文件管理器。
- 在任务栏右键单击 ![deepin-file-manager](icon/deepin-file-manager.svg) ，选择 **关闭所有** 来退出文件管理器。
- 在文件管理器界面点击 ![icon_menu](icon/icon_menu.svg) ，选择 **退出** 来退出文件管理器。
...
| 3    | 图标/列表视图 | 点击 ![icon_view_normal](icon/icon_view_normal.svg) , ![list_view_normal](icon/list_view_normal.svg) 图标，切换文件管理器的界面视图。 |
| 4    | 信息栏        | 点击 ![fileinfo](icon/fileinfo.svg)， 查看文件（夹）的基本信息和标记。 |
| 5    | 菜单栏        | 通过主菜单，您可以新建窗口、切换深色主题、设置共享密码、设置文件管理器、查看帮助文档和关于信息、退出文件管理器。 |
...
![0|copy](jpg/copy.jpg) ![0|stick](jpg/paste.jpg)
...
您可以在文件管理器上的导航栏看到您的本地磁盘，当您挂载外接磁盘或者插入其他移动存储设备时，也可以在导航栏上看到相应的磁盘图标。
...
通过主菜单您可以新建窗口，设置主题，设置文件管理器，查看帮助手册和版本介绍。
...
您可以点击“帮助”获取文件管理器的帮助手册，进一步了解和使用文件管理器。
