...
点击桌面底部的 ![launcher_icon](icon/launcher_icon.svg) ，进入启动器界面。搜索或浏览找到编辑器 ![deepin-editor](icon/deepin-editor.svg)，点击打开。
...
1. 点击 ![icon_menu](icon/icon_menu.svg)，选择 **查找**，或使用组合键 ![Ctrl](icon/Ctrl.svg) + ![F](icon/F.svg) ，可以在下方打开查找窗口。
