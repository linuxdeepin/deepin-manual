...
2. 点击剪贴板内的某一区块，会快速复制当前内容， 且当前区块会被移动到剪贴板顶部。
3. 选择目标位置粘贴。
...
### 系统更新
当系统存在更新时会在控制中心首页提示，点击 ![update](icon/update.svg) 进入"检查更新"页面，检查完毕后，即可开始下载和安装更新。您还可以设置自动下载更新；开启 **智能镜像源**，自动连接响应最快的镜像站，加快下载速度。
...
2. 点击 **更新设置**。
3. 开启 **系统源检测**。
4. 如果系统源被更改，每次开机后会弹出提示“检测到您的系统源已被修改”。点击 **恢复** 恢复到官方源。
