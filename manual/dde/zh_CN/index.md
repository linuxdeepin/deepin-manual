...
## 概述
深度操作系统是深度科技发行的美观易用、安全可靠的国产桌面操作系统。深度系统预装了QQ、搜狗输入法、福昕阅读器、有道词典以及一系列深度特色应用。它既能让您体验到丰富多彩的娱乐生活，也可以满足您的日常工作需要。相信随着功能的不断升级和完善，深度操作系统将会被越来越多的用户所喜爱和使用。

![1|desk](jpg/desk.jpg)

### 系统简介
初次安装深度操作系统，会自动打开欢迎程序。您可以观看视频了解系统的新功能，选择桌面模式和图标主题，开启窗口特效，获得更多关于深度操作系统的知识。
...
![1|launch](jpg/mini.jpg)![1|launch](jpg/launchb.jpg)
...
### 首页介绍
控制中心首页主要展示用户最常用的信息，方便用户日常查看和快速设置。
...
2. 选择一种多屏模式。
 - **复制模式 **将主屏的设置复制到其他显示屏。
 - **扩展模式** 将主屏的显示扩展到其他显示屏。
 - **只在xxx** 将只在xxx显示屏显示屏幕内容。
 - **自定义设置 **需要到控制中心显示设置中添加自定义设置。
...
2. 点击 **左手**/**自然滚动**/**输入时禁用触控板**/**插入鼠标时禁用触控板** 开关按钮，开启相关功能。
