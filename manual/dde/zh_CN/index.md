...
在桌面您可以新建文件/文件夹、排列文件、设置热区、壁纸和屏保等。
...
<table class="block1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>点击可打开深度音乐</td>
            <td class="blank"></td>
    <td><img src="icon/firefox.svg" alt="浏览器" class="inline" /></td>
            <td>点击可打开网页</td>
        </tr>
        <tr>
...
### 显示/隐藏插件
1. 在桌面上，右键单击任务栏。
2. 在 **插件** 子菜单中勾选或取消勾选 **电源、屏幕键盘、时间** ，可以设置电源、屏幕键盘、时间等插件在任务栏上的显示和隐藏效果。
...
### 切换模式
- 启动器有全屏和小窗口两种模式。您可以点击启动器界面右上角的图标切换模式。
- 两种模式均支持搜索应用、设置快捷方式等操作。
- 小窗口模式还支持快速打开文件管理器，控制中心和快速进入关机界面等功能。

![1|launch](jpg/mini.jpg)![1|launch](jpg/fullscreen.jpg)
...
2. 系统会自动搜索包含关键字“deepin”的所有应用，并将搜索结果显示在启动器界面。
...
> ![tips](icon/tips.svg)：您可以根据任务栏上的网络图标，查看当前网络状态。
...
![1|workspace](jpg/openworkspace.jpg)
