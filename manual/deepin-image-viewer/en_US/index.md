...
2. Right click on the image in Deepin Image Viewer interface and select **Slide show**.
3. Deepin Image Viewer will enter fullscreen mode and start slide show.
4. To exit slide show, right click on the slide show and select **End show**, or press ![Esc](icon/Esc.svg) key.
...
![1|image management](jpg/timeline.jpg)
...
2. Right click on the image and select **Favorite**, or click on ![favorite](icon/collect.svg) to add the image to My favorites.
3. Right click on the image and select **Unfavorite**, or click on ![favorite](icon/collect-active.svg) to remove the image from My favorites.
...
![0|display in file manager](jpg/display.jpg)
...
In **Main Menu**, select/unselect **Dark theme** to switch theme.

### Settings

1. In **Main Menu**, click on **Settings**.
...
In **Main Menu**, select **Help** to view the manual of Deepin Image Viewer.
