...
> ![tips](icon/tips.svg)：若要禁用快捷键，请按下键盘上的 ![Backspace](icon/Backspace.svg)。若要取消修改快捷键，按下 **Esc**， 或点击下方的”恢复默认”按钮。
...
![0|assistiveTools](jpg/assistiveTools.png)
...
1. 运行授权管理工具有两种方式：
   ...
   - 点击右下角托盘上的 ![deepin1](icon/uos1.svg)进入界面。

   - 打开 **控制中心**，选择 **系深之度息**，点击 **关于本机**。可查看版本授权栏，点击 **激活** 进入页面。
...
> ![notes](icon/notes.svg)：如果系统未激活，授权管理图标 ![deepin1](icon/uos1.svg)一直常驻在右下角托盘，开机即显示。
...
只有被授权的网络帐户才可以激活系统，可以通过参加活动等方式获取授权资格。

1. 点击右下角托盘上的 ![deepin1](icon/uos1.svg)进入界面。

   ![0|probation1](jpg/probation1.png)

2. 点击 **网络帐户激活**，跳转到网络帐户登录界面。输入帐户及密码，单击 **登录**。

   ![0|login](jpg/login.png)

3. 会弹出二次确认弹框，点击 **激活**，弹出激活成功界面。
...
若激活文件已使用或已失效、网络帐号未授权，则会弹出激活失败界面。
...
#### 用户体验计划
用户体验计划会收集您的硬件信息、应用信息和系深之度息，帮助我们更好地了解用户的使用习惯，进而改善和提升用户体验。为了更好地使用该系统，建议您开启用户体验计划。您可以随时参与或退出该计划。
