...
- 支持固定话语 “你好，小华”或 “你好，小华+命令语”  唤起桌面智能助手，唤起助手对话界面。

> ![notes](icon/notes.svg)：当电脑处于锁屏状态时，不支持唤醒智能助手。
...
- 开启/关闭语音唤醒： 默认为开启状态，当关闭后不在接收唤醒指令。 
- 勾选/去勾选Oneshot面唤醒： 默认为未勾选状态， 勾选开启（oneshot）唤醒命令+语义命令唤起方式， 例如： 你好！小华，北京天气怎样？ 
- 设置音源：女声、男声
- 设置语言：中文-普通话、英语
...
- 开启/关闭朗读所选文本：当有音频输出设备时，默认语音朗读为开启状态；当没有音频输出设备时，则默认为关闭状态；如无音频输出设备则隐藏此项 。
...
| 按键                                                         | 功能                                                         |
| :----------------------------------------------------------- | :----------------------------------------------------------- |
| ![Tab](icon/Tab.svg)                                         | 在不同区域或对话框按钮之间切换。                             |
...
二指距离加大，放大内容，对应 ![Ctrl](icon/Ctrl.svg) + ![=](icon/=.svg)快捷键；

二指距离缩小，缩小内容，对应 ![Ctrl](icon/Ctrl.svg) + ![-](icon/-.svg)快捷键；
...
1. 三指点击，激活当前窗口的移动状态，对应 ![Alt](icon/Alt.svg) + ![F7](icon/F7.svg) 快捷键。
