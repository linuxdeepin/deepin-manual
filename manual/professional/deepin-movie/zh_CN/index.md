...
影院提供了直观易用的操作界面和丰富齐全的快捷键，依靠键盘您就能完成所有的播放操作，让您彻底摆脱鼠标点击的束缚。您可以使用影院播放多种格式的视频文件。
...
您可以通过以下方式来播放影片：
- 当播放列表没有文件时，点击 ![play](icon/play_normal.svg)，打开文件选择器选择影片文件。
- 单击鼠标右键或从![menu](icon/icon_menu.svg)选择 **打开文件**，打开文件选择器选择影片文件。
...
1. 在影院界面，按下键盘上的 ![Ctrl](icon/Ctrl.svg)+![Right](icon/Right.svg) 键，视频加速播放。
...
2. 将鼠标移动到 **截图**，您可以：
 - 选择 **截图**，可以对当前画面进行截图。
 - 选择 **剧情连拍**，可以分别截取影片不同时段的图片，最后组成一张剧情连拍预览图。
...
3. 在 **播放** 选项，您可以：
  ...
  - 勾选 **允许同时运行多个影院** 复选框，可以同时打开多个影院窗口来播放不同的视频文件。
  - 勾选 **最小化时暂停** 复选框，在影院最小化时自动暂停视频文件的播放。
4. 在 **截图** 选项，您可以自定义截图的保存路径。

![1|setting](jpg/setting1.png)
