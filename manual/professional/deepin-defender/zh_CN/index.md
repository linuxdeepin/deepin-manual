...
安全中心是UOS预装的安全辅助软件，主要包括系统体检、安全等级设置、病毒查杀、防火墙等功能，可以全面提升系统的安全性。
...
- 安全等级为 **高** 或 **中** ：在控制中心修改密码，或创建新用户设置密码时，若设置的密码不符合级别要求，会保存失败。并提示前往安全中心修改等级或重新设置密码。
- 安全等级为 **低** ：在控制中心修改密码，或创建新用户是设置密码的时候，直接保存新设置的密码。
