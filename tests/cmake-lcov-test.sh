...
lcov --remove ./coverage/coverage.info '*/${project_name}_test_autogen/*' '*/${project_name}_autogen/*' '*/usr/include/*' '*/app/*' '*obj-x86_64-linux-gnu/*' '*/test/*' '*/dbus/*.h' -o ./coverage/coverage.info
