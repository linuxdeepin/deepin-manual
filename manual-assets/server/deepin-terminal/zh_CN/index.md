...
雷神模式是终端特有的便捷功能，使用快捷键 **Alt + F2** 就可以打开雷神终端窗口，再按一下 **Alt + F2** 隐藏雷神终端窗口。
...
1. 在终端界面，单击 ![icon_menu](icon/icon_menu.svg)。
2. 单击 **退出**。
<div class="version-info"><span>文档更新时间: 2021-08-18</span><span> 版本: 5.4</span></div>