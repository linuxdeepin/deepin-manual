...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到终端 ![deepin-terminal](icon/deepin-terminal.svg) 单击运行。
...
1. 在终端界面，单击 ![icon_menu](icon/icon_menu.svg)。
2. 单击 **退出**。
<div class="version-info"><span>文档更新时间: 2021-01-22</span><span> 版本: 5.3</span></div>