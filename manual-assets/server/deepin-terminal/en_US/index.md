...
3. In the tab of **Basic**, you can set the font and font size.
...
1. Click ![icon_menu](icon/icon_menu.svg)on the interface. Click **Settings**.

2. In the tab of **Advanced**, you can:
   ...
   - Set window type.
   - Hide Quake window after losing focus.
3. Click **Restore defaults** to restore all settings to default.  
...
<div class="version-info"><span>Update Date: 2020-08-26</span><span> Version: 5.2</span></div>