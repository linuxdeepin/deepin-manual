...
3. Select a website for your search.
...
The window theme provides three theme types, namely Light Theme, Dark Theme (default), and System Theme.
...
3. In the **Shortcuts** options, you can:
  ...
  - Select the shortcut you want to disable. When **Enter a new shortcut** shows in the input box, press **Backspace** on the keyboard to disable it. 
...
4. Click **Restore Defaults** to restore to all default settings.  
