...
Place the pointer over the white boarder of the screenshot area and the pointer will be changed to ![1](icon/Mouse_Arrow.svg)You can:
...
3.  Click ![1](icon/line_normal.svg) or ![箭头](icon/Arrow-normal.svg) to toggle between straight line and arrow.
