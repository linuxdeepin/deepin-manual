...
1. 系统会预装中文输入法，点击右下角托盘上的 ![onboard](icon/onboard.svg)进入输入法配置页面。
2. 点击 **输入法**，选择**中文输入法**，托盘中输入法图标变为![inputer](icon/inputer.svg)，则表示切换成功。
...
进入属性设置界面有两种方式，一种是右键点击中文输入法 ![inputer](icon/inputer.svg)，弹出选框，选择 **属性设置**；另一种是在状态栏中点击 ![set1](icon/set1.svg)。在属性设置界面，可对中文输入法进行设置，设置项为常用、外观、词库、高级、拼音和五笔。
