...
> ![tips](icon/tips.svg)Tips: The number of sides, points and radius can be adjusted by clicking ![icon](icon/Up.svg) or ![icon](icon/Down.svg) on the attribute column, scrolling the mouse wheel or pressing the ![up](icon/up.svg) or ![up](icon/down.svg) key on the keyboard after selecting the value of sides, points or radius.
