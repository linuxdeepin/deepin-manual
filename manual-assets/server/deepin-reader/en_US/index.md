...
- Right-clicking it and selecting **Open with** > **Select default program**, and then selecting Document Viewer from the list.
   ...
   > ![tips](icon/tips.svg)Tips: Document will be opened by default program by directly double clicking on it. You can right-click it and select a default program by clicking on **Properties** > **Open with**. 
...
>![notes](icon/notes.svg)Notes: when there are many windows, the file will be opened in the one which was opened first, and one file could only be opened once.
...
- When there are two or more tabs, you will see ![add](icon/add.svg) button. And you can click it to add new tabs.
...
In the main menu, you can create new window and new tabs, save (see [Save documents](#Save documents)), [search](#Search), switch themes, view help to know more about Document Viewer. 
