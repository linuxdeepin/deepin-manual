...
2. Click ![view](icon/setting_normal_light.svg)and select **Rotate Left** or **Rotate Right** from the sub menu, the page will rotate to the left or right by 90°. 
...
In the main menu, you can [save](#Save documents), [print](#Print documents), view document info, switch themes, view help to know more about Document Viewer. 
