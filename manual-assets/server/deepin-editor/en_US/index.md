...
> ![tips](icon/tips.svg) Tips: Select the text and then press **Ctrl + F**. The text will be automatically displayed in the **Find** box.
...
- Delete bookmark
   ...
   + Right-click the colored bookmark icon ![bookmarkbig](icon/bookmarkbig_checked_light.svg) to select **Remove Bookmark** to delete the bookmark in the line.
...
1. Click ![icon_menu](icon/icon_menu.svg)> **Settings** and you can perform the following in the **Basic** option:
