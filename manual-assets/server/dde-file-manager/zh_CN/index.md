...
![1|batch rename](jpg/batch rename.png)
...
#### 高级搜索
1. 在搜索状态下，输入关键字后按 **Enter** 键，单击右侧的 ![filter](icon/filter.svg) 进入高级搜索。
...
1. 选择您要预览的视频文件，按下空格键， 单击 **打开 **即可开始预览。
2. 单击视频任意地方可暂停播放。
