...
1. 在搜索状态下，输入关键字后按 **Enter** 键，当搜索到结果时，搜索框右侧显示图标 ![filter](icon/filter.svg) ，单击该图标可以进行高级搜索的操作。
...
> ![tips](icon/tips.svg)窍门：如果要弹出光盘，请选择 **弹出** 来移除光盘。单击导航栏中磁盘右边的按钮 ![unmount](icon/unmount_normal.svg) 同样可以弹出磁盘或光盘。
...
<div class="version-info"><span>文档更新时间: 2021-08-18</span><span> 版本: 5.2</span></div>