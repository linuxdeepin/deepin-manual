...
> ![notes](icon/notes.svg) Notes: Single and batch font(s) export are supported. System fonts cannot be exported.
...
> ![notes](icon/notes.svg) Notes: Enable/Disable functions are available for a single font and a batch of fonts. System fonts and fonts currently being used can not be disabled.
...
> ![notes](icon/notes.svg) Notes: Delete function is available for a single font and a batch of fonts. System fonts and fonts currently being used can not be deleted.
...
![0|font_delete](jpg/font_delete.png)
...
<div class="version-info"><span>Update Date: 2021-08-18</span><span> Version: 5.8</span></div>