...
| ![dde-file-manager](icon/dde-file-manager.svg) | 文件管理器 - 单击查看磁盘中的文件、文件夹。 | ![browser-cn](icon/browser-cn.svg) | 浏览器 - 单击打开网页。 |
...
| ![onboard](icon/onboard.svg)        | 屏幕键盘 - 单击使用虚拟键盘。 |![shutdown](icon/system-shutdown.svg) | 电源 - 单击进入关机界面。 |
...
<div class="version-info"><span>文档更新时间: 2021-04-14</span><span> 版本: 2021.04</span></div>