...
1. 运行授权管理工具有两种方式：
   ...
   - 点击右下角托盘上的 ![sys_auth1](icon/sys_auth1.svg)进入界面。
...
1. 点击右下角托盘上的 ![sys_auth1](icon/sys_auth1.svg)进入界面。

   ![0|probation1](jpg/probation1.png)

2. 点击 **试用期激活**，跳转到激活界面。

3. 点击 **立即激活**，会弹出二次确认弹框，点击 **确定**，弹出试用期激活成功界面，任务栏图标变为![sys_auth2](icon/sys_auth2.svg)。
...
3. 点击 **开始备份**，弹出密码输入框，请输入密码授权备份文件，直至文件备份完成。
...
<div class="version-info"><span>文档更新时间: 2020-09-11</span><span> 版本: 2020.03</span></div>