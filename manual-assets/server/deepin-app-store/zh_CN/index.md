    ...
    <tbody>
        ...
        <tr>
         ...
         <tr>
            <td>4</td>
            <td>主菜单</td>
            <td>在主菜单中您可以清除缓存、切换主题、查看帮助手关于信息、退出应用商店。</td>
        </tr>
        <tr>
   </tbody>
   </table>
...
您可以通过应用商店搜索、下载、安装不同分类的应用，同时还可以根据热门推荐、热门专题、下载排行等不同方式挖掘更多精彩应用。
...
<div class="version-info"><span>文档更新时间: 2021-01-22</span><span> 版本: 6.2</span></div>