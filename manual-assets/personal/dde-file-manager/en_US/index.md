# File Manager|../common/dde-file-manager.svg|
...
File Manager supports a variety of searching methods, including ordinary search by file name and file content, and advanced search by file type and creation time, so as to improve work efficiency and facilitate file management.
...
UnionTech OS Assistant is a practical tool to realize cross terminal cooperation and efficient transmission between mobile phone and computer. It only needs to connect the mobile phone and PC with the same Wi-Fi to easily transfer pictures, videos, files, etc.
...
3. Open your phone, scan the QR code with your WeChat or browser to download and install UnionTech OS Assistant. You can also click **Download APK** to download it locally and import it into your phone for installation.

>![notes](icon/notes.svg)Notes: Only Android phones are supported.

### Connect PC with phone

Prerequisite: PC and mobile terminal must be connected to the same Wi-Fi network.

1. Click ![icon](icon/phone.svg) in the system tray or open File Manager and click **My Phone** in the left panel.
2. Click **Connect**, a window with a QR code inside pops up.

![phone](jpg/myphone1.png)

3. Open UnionTech OS Assistant on your phone, scan the QR code and connect. After the connection is successful, folders in the phone would be displayed in "My phone" interface on PC.
>![notes](icon/notes.svg)Notes: you can disconnect from your phone, or right-click ![icon](icon/phone.svg) in the system tray on PC, select your phone and click **Disconnect**.

### Transfer files
After the connection between the mobile phone and PC is successful, files can be transferred to each other.

**From phone to PC**

Open UnionTech OS Assistant on your phone, you can:
   - Send texts and files(such as images, videos, audios and so on) to PC;
   - Take photos or shoot videos and edit on them, and then send to PC;
   - Share the transferred files to any third-party;
   - View the recent files and empty the transferring history.

**From PC to phone**
   - On PC, right-click a file or compressed package and send to your phone.
   - On PC, drag a file onto **My phone** in the left panel of File Manager.
...
### Local Disks
#### Hide Local Disks
1. Click ![icon_menu](icon/icon_menu.svg)> **Settings** on the interface of File Manager.
...
<div class="version-info"><span>Update Date: 2021-04-29</span><span> Version: 5.2</span></div>