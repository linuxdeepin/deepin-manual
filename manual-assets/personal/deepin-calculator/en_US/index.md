...
- Select **Standard** to execute the four fundamental operations of arithmetic(addition, subtraction, multiplication and division).
- Select **Scientific** to calculate high-level operations such as function, exponent, root, and so on. 
...
<div class="version-info"><span>Update Date: 2021-04-29</span><span> Version: 5.6</span></div>