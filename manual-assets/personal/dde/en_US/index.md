...
Authorization management is a pre-installed system tool to help you activate the system.  Here mainly introduces the unactivated interface, and activated interfaces and so on.
...
In case that system is not activated successfully, **Unactivated** is displayed on the interface.
Please check:

- If the network connection is OK.
- If the server is connected correctly.

If network settings are OK and server is running smoothly, you can manually activate the system as follows:

1. Enter the authorization management interface.
...
2. Click **Activate Now** to activate the authorization management function.

![0|activation_code3](jpg/activation_code1.png)

#### Activated Interface

The system is activated upon startup. **Activated** is displayed on the interface. You can view the authorization management information in **Control Center > System Info > About This PC**.
> ![notes](icon/notes.svg)Notes: If the system is activated, the authorization management icon ![uos1](icon/uos1.svg)will not be seen on the tray in the lower right corner.

![0|activation_code3](jpg/activation_code3.png)

You can click **Value Added Services** to go to the service website, you can also subscribe to value added services you want.
