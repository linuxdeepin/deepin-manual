...
![1|fashion](fig/s_dock-efficient.png)

| 图标 | 说明 | 图标 | 说明 |
| ------------------------------------------------------------ | :---------------------------------- | -------------------------------------------------------- | --------------------------------------------------- |
| ![launcher](../common/deepin-launcher.svg)                   | 启动器 - 点击查看所有已安装的应用。 | ![deepin-toggle-desktop](../common/deepin-toggle-desktop.svg) | 显示桌面。                                          |
| ![dde-file-manager](../common/dde-file-manager.svg) | 文件管理器 - 点击查看磁盘中的文件、文件夹。 | ![browser-cn](../common/browser-cn.svg) | 浏览器 - 点击打开网页。 |
...
![1|fashion](fig/s_dock-fashion.png)

![1|efficient](fig/s_dock-efficient.png)
...
> ![notes](../common/notes.svg)说明：开启 **智能镜像源**，系统会自动匹配响应最快的镜像源。
...
1. 运行授权管理工具有两种方式：
   ...
   - 单击右下角托盘上的 ![sys_auth1](../common/sys_auth1.svg)进入界面。
...
> ![notes](../common/notes.svg)说明：如果系统未激活，授权管理图标 ![sys_auth1](../common/sys_auth1.svg)一直常驻在右下角托盘，开机即显示。
...
1. 单击右下角托盘上的 ![sys_auth1](../common/sys_auth1.svg)进入界面。

   ![0|probation1](fig/e_probation1.png)

2. 单击 **试用期激活**，跳转到激活界面。

3. 单击 **立即激活**，会弹出二次确认弹框，单击 **确定**，弹出试用期激活成功界面，任务栏图标变为![sys_auth2](../common/sys_auth2.svg)。
