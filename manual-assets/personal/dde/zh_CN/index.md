...
> ![attention](icon/attention.svg)注意: 已登录的账户无法被删除。
...
UOS提供从Grub进入还原、控制中心还原的还原方式。

##### 从Grub进入还原

在开机时，选择系统界面，点击 **uos系统还原**，进入UOS系统还原，用户可以选择“恢复UOS出厂设置”读取恢复出厂设置备份，也可以选择“恢复UOS历史备份”打开文件目录选取要还原的备份。
...
2. 选择 **备份/还原** > **还原**，您可以选择：
   ...
   - 手动还原
      1. 在选择还原目录参数后，点击![three_dots](jpg/three_dots.png)选择要还原的文件。
      2. 点击 **还原**，开始还原系统。
...
2. 点击 **开发者模式**，点击 **进入开发者模式** 按钮。
   - 若选择在线模式，请先登录Union ID。仔细查看开发者模式免责声明，了解注意事项后，勾选 **同意并进入开发者模式**，点击 **确定**。待系统下发证书后，按钮变为 **已进入开发者模式**。
