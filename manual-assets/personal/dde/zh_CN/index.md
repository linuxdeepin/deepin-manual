...
![1|fashion](jpg/h_fashion.png)

![1|efficient](jpg/h_efficient.png)
...
> ![tips](icon/tips.svg)窍门：选中文字按下 **Ctrl** + **Alt** + **P** 可以进行语音朗读；连接录音设备后，输入框内按下 **Ctrl** + **Alt** + **O** 进入听写模式，把语音输入转换为文字。
...
|休眠![sleep_hover](icon/sleep_hover.svg)| 没有swap分区不显示此项。有swap分区的机器休眠挂载到硬盘。 |
...
![1|launch](jpg/h_fullscreen.jpg)![1|launch](jpg/h_mini.jpg)
...
![2|dcchomepage](jpg/h_dcc.png)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

打开控制中心的某一设置模块后，可以通过左侧导航栏快速切换到另一设置模块。

![2|cc-navigation](jpg/h_cc-navigation.png)
...
![0|account](jpg/h_account.png)

#### 创建新帐户

1. 在控制中心首页，单击 ![account_normal](icon/dcc_nav_accounts_42px.svg)。
...
![0|video](jpg/h_display.png)

#### 单屏设置

##### 更改分辨率

1. 在控制中心首页，单击 ![display_normal](icon/dcc_nav_display_42px.svg)。
2. 单击 **分辨率**，进入分辨率设置界面。
3. 在列表中选择合适的分辨率参数。
4. 单击 **保存**。
...
![0|default](jpg/h_cc-navigation.png)
...
1. 在控制中心首页，单击 ![default_applications_normal](icon/dcc_nav_defapp_42px.svg)。
2. 选择一个文件类型进入默认程序列表。
3. 在列表中选择另一个应用程序。
...
![p0|personalise](jpg/h_personalise.png)

#### 设置窗口主题
1. 在控制中心首页，单击 ![personalization_normal](icon/ddcc_nav_personalization_42px.svg)。
2. 单击 **通用**，选择一种窗口主题。
3. 该主题即为系统窗口主题。
...
1. 将网线插入电脑上的网络插孔。
2. 将网线的另一端插入路由器或网络端口。
3. 在控制中心首页，单击  ![network_normal](icon/dcc_nav_network_42px.svg)。
...
1. 在控制中心首页，单击  ![network_normal](icon/dcc_nav_network_42px.svg)。
...
1. 在控制中心首页，单击  ![network_normal](icon/dcc_nav_network_42px.svg)。
2. 单击 **VPN**，选择 **添加VPN** 按钮 ![add](icon/add.svg) 或 **导入VPN** 按钮 ![import](icon/import.svg)。
...
![0|sound](jpg/h_notification.png)

#### 设置系统通知

设置系统通知的勿扰模式及是否在任务栏显示通知图标。

1. 在控制中心首页，单击 ![dcc_nav_notification_36px](icon/dcc_nav_notification_42px.svg)。
...
![0|sound](jpg/h_sound.png)


#### 输出设备

1. 在控制中心首页，单击 ![sound_normal](icon/dcc_nav_sound_42px.svg)。
...
1. 在控制中心首页，单击  ![bluetooth_normal](icon/dcc_nav_bluetooth_42px.svg)。
...
![0|time](jpg/h_time.png)

#### 修改时区
在您安装系统时，已选择了系统时区。若要修改系统时区，请按如下步骤设置。

1. 在控制中心首页，单击 ![time](icon/dcc_nav_datetime_42px.svg)。
2. 单击 **时区列表**。
...
![m0|power](jpg/h_power.png)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

#### 调整性能模式

1. 在控制中心首页，单击 ![power_normal](icon/dcc_nav_power_42px.svg)。
2. 单击 **通用**。
3. 在性能模式区域，选择 **平衡模式**、**高性能模式** 或 **节能模式**。

> ![notes](icon/notes.svg)说明：仅当硬件支持高性能模式时，才显示 **高性能模式**  选项。
...
![0|mouse](jpg/h_mouse.png)

#### 通用设置

1. 在控制中心首页，单击 ![mouse_touchpad_normal](icon/dcc_nav_mouse_42px.svg)。
2. 单击 **通用**。
...
![0|graphics-tablet](jpg/h_drawingTablet.png)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

1. 在控制中心首页，单击![drawing](icon/dcc_nav_wacom_42px.svg) 。
2. 选择 **笔** 模式。
3. 调节 **压感力度**。
...
![0|keyboard](jpg/h_keyboard.png)

#### 键盘属性

1. 在控制中心首页，单击 ![keyboard_normal](icon/dcc_nav_keyboard_42px.svg)。
2. 单击 **通用**。
2. 调节 **重复延迟**/**重复速度**。
...
![0|auxiliary](jpg/h_auxiliary_function.png)
...
### 系统更新
当系统存在更新时会在控制中心首页进行提示，单击 **更新** 按钮 ![update](icon/dcc_nav_update_42px.svg) 进入 **更新** 页面，单击 **检查更新**，检查完毕后，即可进行下载和安装更新。除此之外，在更新设置模块中还可以设置自动下载更新。

> ![tips](icon/tips.svg)窍门：如果不需要检查更新，不需要收到系统或应用的更新提示，可在“更新设置”中关闭“检查更新”或“更新提醒”。

![0|update](jpg/h_update.png)


#### 更新和升级

1. 在控制中心首页，单击 ![update](icon/dcc_nav_update_42px.svg)。
...
![0|info](jpg/h_info.png)

#### 关于本机

1. 在控制中心首页，单击 ![system_info_normal](icon/dcc_nav_systeminfo_42px.svg)。
...
- 单击系统托盘上的 ![authorize1](icon/authorize1.svg) 或 ![authorize1](icon/authorize2.svg) 进入授权管理界面。
- 打开 **控制中心**，选择 **系统信息**，单击 **关于本机**。在版本授权栏，单击 **激活** 进入授权管理界面。
...
![0|activation](jpg/h_activation3.png)
...
![0|backup-recovery](jpg/h_backupRestore.png)
...
1. 在控制中心首页，单击 ![general](icon/dcc_nav_commoninfo_42px.svg)。
2. 单击 **启动菜单**，进入启动菜单界面。
...
![1|workspace](jpg/h_workspace.png)
...
<div class="version-info"><span>文档更新时间: 2021-04-29</span><span> 版本: 2021.04</span></div>