...
1. 在控制中心首頁，單擊 ![display_normal](../common/display_normal.svg)。
2. 單擊  **旋轉螢幕** 按鈕 ![rotate](../common/rotate.svg)。
3. 每單擊一下鼠標左鍵，螢幕逆時針旋轉90°。
4. 要還原為之前的螢幕方向，單擊鼠標右鍵退出；要使用當前螢幕方向，請按下組合鍵 **Ctrl** + **S** 保存。

#### 多萤幕顯示設置

多萤幕顯示，讓您的視野無限延伸！使用VGA、HDMI、DP等線纜將您的電腦和另一台顯示器、投影儀等連接起來，同時在多個螢幕顯示您電腦上的內容。
...
3. 手機掃描二維碼，手機端彈出啟動界面，界面顯示當前機器ID及序列號。
