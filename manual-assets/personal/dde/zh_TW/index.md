...
<img src="fig/p_dcc.png" alt="2|dcchomepage" style="width:800px;" />

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

打開控制中心的某一設定模組後，可以透過左側導航欄快速切換到另一設定模組。

<img src="fig/p_cc_navigation.png" alt="2|cc-navigation" style="width:800px;" />
...
如果您尚未註冊Union ID，可以在官網先進行註冊（支援微信掃描、手機號碼等方式進行註冊），註冊成功並登入後，才能使用Union ID的相關功能。
...
<img src="fig/p_cc_navigation.png" alt="0|default" style="width:800px;" />
...
<img src="fig/p_personalise.png" alt="p0|personalise" style="width:800px;" />
...
<img src="fig/p_notification.png" alt="0|sound" style="width:800px;" />
...
<img src="fig/p_power.png" alt="m0|power" style="width:800px;" />
...
<img src="fig/p_graphicstablet.png" alt="0|graphics-tablet" style="width:800px;" />
...
<img src="fig/auxiliary_function.png" alt="0|auxiliary" style="width:800px;" />
...
每台設備安裝系統後，可試用30天，試用期內，用戶可使用系統全部功能，也可隨時在試用期內啟動系統，啟動後可永久使用。

超過試用期，應用商店下載和系統更新功能將無法使用。
...
>![notes](../common/notes.svg) 說明：用戶也可在第一次啟動系統的歡迎頁面中，單擊 **立即啟動** 啟動系統。

#### 啟動成功

系統啟動成功後，在“控制中心 > 系統訊息 > 關於本機”中，單擊 **查看** 可以查看授權管理訊息。
...
<img src="fig/p_backup_recovery.png" alt="0|backup-recovery" style="width:800px;" />
