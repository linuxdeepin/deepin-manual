...
deepin 作業系統是一款美觀易用、安全可靠的國產桌面作業系統。deepin 預裝了檔案管理器、應用商店等一系列原生應用程式。它既能讓您體驗到豐富多彩的娛樂生活，也可以滿足您的日常工作需要。隨著功能的不斷升級和完善，deepin 作業系統已成為中國最受歡迎的桌面作業系統之一。
...
| ![ deepin-album](../common/deepin-album.svg)                 | 相冊 - 匯入並管理照片。 |
...
前提條件：發送端（Deepin  PC）藍牙裝置與接收端（非 Deepin  PC/手機/平板）藍牙裝置已配對並連接成功。
