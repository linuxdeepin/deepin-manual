...
> ![notes](icon/notes.svg)Notes: Font Manager will detect your fonts automatically. If the font has been installed locally, a prompt message will pop up to advise you that font of the same version has been installed. You can select **Exit** or **Continue** to exit or continue the installation.
...
> ![notes](icon/notes.svg)Notes: If you want to use the installed font as system font, you can open **Control Center**, click **Font** in **Personalization**, and set the font as **Standard Font**.
