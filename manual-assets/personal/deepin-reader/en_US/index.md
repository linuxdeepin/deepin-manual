...
- Delete bookmark:
   ...
   - Click![menu](icon/thumbnail_normal_light.svg) to open the toolbar on the left, and then click ![view](icon/bookmark_normal.svg)in the lower part to open the bookmark catalog, right-click any page, select **Remove bookmark**, the bookmark on this page is deleted. 
...
- Delete note 
   ...
   - Click![menu](icon/thumbnail_normal_light.svg) to open the toolbar on the left, and then click ![view](icon/comments_normal_light.svg)in the lower part to open the annotation catalog, right-click any annotation, select **Remove annotation**, the annotation on this page is deleted and so is its content. 
