...
2. The image will rotate clockwise or counterclockwise for 90 degrees.
   ...
   ![notes](icon/notes.svg) Notes:  If you are using a computer with touchscreen, place two fingers on the image and keep a certain distance, and rotate the two fingers at the same time to rotate the iamge.
