...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到相机图标 ![camera](icon/camera.svg) ，单击运行。
...
在相机主界面，右键单击图片或视频文件，可以选择复制、删除或打开文件夹。
...
<div class="version-info"><span>文档更新时间: 2021-05-17</span><span> 版本: 1.0</span></div>