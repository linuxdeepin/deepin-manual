...
2. Select **Virus scan**, the **Virus Scan** interface of Security Center pops up, so you can scan the file(folder) for virus. Refer to the chapter Virus Scan in the manual of Security Center for detailed operations.

   >![notes](icon/notes.svg)Notes: If there is a scanning task in Security Center currently, click **View** in the pop-up dialog box to enter the virus scanning interface of Security Center.
   >
...
<div class="version-info"><span>Update Date: 2021-07-07</span><span> Version: 5.2</span></div>