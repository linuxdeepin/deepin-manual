...
![tips](icon/tips.svg)Tips: In Control Center, you can set Draw as the defaulted picture viewer. Please refer to [Default Applications](dman:///dde#Default Applications) for specific operations.
...
- You can also click ![add](icon/add.svg) to create a new tab when there are two or more tabs in the window.
...
1. On the Draw interface, click  ![rectangle](icon/rectangle_normal.svg), ![oval](icon/oval_normal.svg) ,![triangle](icon/triangle_tool_normal.svg),![star](icon/draw_star.svg) or ![hexagon](icon/hexagon_tool_normal.svg).
2. You can set the parameters for graphics as follows:
 ...
 - Choose and set the weight of Stroke from the drop-down list right to the **Stroke** icon.
...
>![tips](icon/tips.svg) Tips: You can use shortcuts to adjust the font size. When the font is under editing,  click the font size right to the **Size** icon and click the ![up](icon/up.svg) or ![up](icon/down.svg) key on the keyboard to adjust the font size.
...
3. Press the **Enter** key or click the ![check](icon/check.svg)icon on the attribute column to crop the canvas.
...
1. On the Draw interface, select an imported picture.
2. Click ![rotate](icon/rotate_right_normal.svg) or ![rotate](icon/rotate_left_normal.svg) to rotate the picture for 90 degrees clockwise or counterclockwise. Or rotate the picture by clicking the![icon](icon/icon_rotate.svg) icon on the picture.

![1|roll_over](jpg/rotate.png)
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
2. Right-click and select **Delete** or use the **Delete** key on the keyboard to delete the selected picture.

![1|delete](jpg/delete.png)

## Main Menu

In the main menu, you can create a new tab, [Import Pictures](#Import Pictures), [Export Pictures](#Export Pictures), [Save Pictures](#Save Pictures), [Print Pictures](#Print Pictures), switch window themes, view help manual, and get more information about Draw.
...
<div class="version-info"><span>Update Date: 2021-06-08</span><span> Version: 5.8</span></div>