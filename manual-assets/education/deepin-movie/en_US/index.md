...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
> ![notes](icon/notes.svg) Notes: The preview window will display by default when the mouse is placed over the progress bar. If you do not need to display the preview window, you can uncheck the **Show video preview on mouseover** box in Settings.
...
- On the Movie interface, right-click, select **Open URL**, and paste the URL address to play the film.
...
>![notes](icon/notes.svg) Notes: If you are using a computer equipped with a touchscreen, slide leftward with one finger on the video picture area to rewind and rightward to forward under the fullscreen mode.
...
> ![notes](icon/notes.svg) Notes: If you are using a computer equipped with a touchscreen, slide upward with one finger on the video picture area to increase the volume and downward to decrease the volume under the fullscreen mode.
...
> ![tips](icon/tips.svg) Tips: On the Playlist interface, hover the mouse pointer over the video file and click ![close](icon/close.svg) to delete it.
...
<div class="version-info"><span>Update Date: 2021-06-08</span><span> Version: 5.7</span></div>