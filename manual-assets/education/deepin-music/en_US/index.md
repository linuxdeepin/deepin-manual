...
<table class="block1">
    ...
    <tbody>
    	...
    	<tr>
            <td>8</td>
            <td>Lyrics</td>
            <td>Click it to switch to the lyrics interface and click it again to fold the lyrics interface.</td>
        </tr>
    		<tr>
            <td>9</td>
            <td>Play mode</td>
            ...
            <td>10</td>
            <td>Volume</td>
            <td>Click it to adjust the volume by dragging the volume bar.</td>
        </tr>
    		<tr>
            <td>11</td>
            <td>Play Queue</td>
