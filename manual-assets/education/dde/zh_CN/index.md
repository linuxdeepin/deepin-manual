...
> ![notes](icon/notes.svg)说明：当使用触屏电脑时，在触摸屏上从屏幕左侧边缘划入超过任务栏高度，唤出剪贴板。
...
| ![browser-cn](icon/browser-cn.svg) | 浏览器 - 单击打开网页。           | ![deepin-appstore](icon/deepin-appstore.svg)        | 商店 - 搜索安装应用软件。                           |
...
此外，还可以单击任务栏上的 ![notification](icon/notification.svg)， 打开通知中心，查看所有通知。
...
## 启动器
启动器 ![launcher](icon/deepin-launcher.svg) 可以管理系统中所有已安装的应用，在启动器中使用分类导航或搜索功能可以快速找到需要的应用程序。
...
当显示屏为单屏时，可以修改屏幕分辨率、亮度、缩放、刷新率和显示方向。
...
> ![notes](icon/notes.svg)说明：当关闭 **使用电池时自动开启** 节能模式时，则直接进入 **平衡模式**。
...
### 系统更新
当系统存在更新时会在控制中心首页进行提示，单击 **更新** 按钮 ![update](icon/update.svg) 进入"检查更新"页面，检查完毕后，即可进行下载和安装更新。除此之外，在更新设置模块中还可以设置自动下载更新。

> ![tips](icon/tips.svg)窍门：如果不需要检查更新，不需要收到系统或应用的更新提示，可以在“更新设置”中关闭“检查更新”或“更新提醒”。
...
每台设备仅有一次试用期激活机会（为开机自动激活），从激活当天算起，有效期为90天。试用期间可使用系统全部功能。
...
<div class="version-info"><span>文档更新时间: 2021-07-07</span><span> 版本: 2020.11</span></div>