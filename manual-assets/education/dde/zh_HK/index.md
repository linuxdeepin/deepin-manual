...
| 休眠![sleepHover](../common/sleep_hover.svg)                 | 沒有swap分區不顯示此項。有swap分區的機器休眠掛載到硬碟。 |
...
![0|backup-recovery](fig/edu_backupRestore.png)
...
![1|workspace](fig/edu_workspace.jpg)
