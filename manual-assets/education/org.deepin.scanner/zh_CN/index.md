...
在扫描管理器主界面，单击扫描按钮![scan-botton](jpg/scan-botton.png)，列表会显示与当前电脑连接上的所有扫描设备，如拍摄仪和扫描仪。如果没有显示对应的设备列表，则需要安装驱动。
...
3. 驱动安装成功后，返回主界面再次单击扫描按钮![scan-botton](jpg/scan-botton.png)，直到设备显示在列表中。
