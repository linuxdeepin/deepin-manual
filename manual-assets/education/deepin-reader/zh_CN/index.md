...
- 当标签页达两个或两个以上时，会显示按钮 ![icon](icon/add.svg) ，单击该按钮添加新标签页。
...
- 添加书签
   ...
   - 将鼠标移至浏览页面右上角书签区域，显示书签图标 ![view](icon/bookmark.svg)，单击图标为当前页添加书签，书签图标变为蓝色填充的图标 ![view](icon/bookmarkbig_checked_light.svg)。
- 删除书签：
...
- 复制注释
   -  在页面上，右键单击已完成注释的文本内容，选择 **复制**，复制该条注释的全部内容。
