...
You can fine-tune the screen capture area. For example, you can enlarge or reduce the screen capture area, and move the screen capture position, among other functions. 

#### Enlarge/Reduce the Screen Capture Area

- Place the pointer over the white boarder of the screen capture area and the pointer will be changed to ![mouse_arrow](icon/Mouse_Arrow.svg). Hold down the left mouse button and drag the mouse to enlarge or reduce the screen capture area. 


- Press **Ctrl** + ![up](icon/Up.svg) , ![down](icon/Down.svg) , ![left](icon/Left.svg) or ![right](icon/Right.svg) and drag the mouse to enlarge or reduce the screen capture area vertically or horizontally.

#### Move the Screen Capture Area Position

Place the pointer over the screen capture area and it will be changed to ![finger](jpg/fingers2.png). You can:

- Hold down the left mouse button and drag the mouse to move the position of the screen capture area.
- Press ![up](icon/Up.svg) , ![down](icon/Down.svg) , ![left](icon/Left.svg) or ![right](icon/Right.svg) on the keyboard to move the screen capture area vertically or horizontally.
...
1. Click ![oval](icon/oval_normal.svg) on the toolbar which appears beside the screenshot area.
...
1. Click ![line_normal](icon/line_normal.svg) on the toolbar which appears beside the screenshot area.
...
1. Click ![combined_shape](icon/Combined_Shape.svg) on the toolbar which appears beside the screenshot area.
