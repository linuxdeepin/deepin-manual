...
3. In the **Basic** options, you can:
    ...
    >![notes](icon/notes.svg) Notes: if Window Effect is turned off in Control Center, the **Opacity** scroll bar will be hidden.
...
4. **Restore Defaults**: Click this icon to restore to all default settings.
...
<div class="version-info"><span>Update Date: 2021-01-15</span><span> Version: 5.3</span></div>