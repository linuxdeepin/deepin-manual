...
4. Click **Add**.
   ...
   >  ![notes](icon/notes.svg) Notes: If you need to set up more parameters, click **Advanced options**. 
...
<div class="version-info"><span>Update Date: 2021-08-10</span><span> Version: 5.3</span></div>