...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到文本编辑器图标 ![deepin_editor](icon/deepin_editor.svg)，单击运行。
3. 右键单击 ![deepin_editor](icon/deepin_editor.svg)，您可以：
...
- 新建标签页/窗口
   ...
   - 单击标签页上的按钮 ![plus_icon](icon/+.svg) 或 ![icon_menu](icon/icon_menu.svg) > **新标签页** 或使用快捷键 **Ctrl + T** 创建一个新的标签页。
...
- 在文本编辑器界面，单击 ![icon_menu](icon/icon_menu.svg) > **打开文件** 或使用快捷键 **Ctrl + O**，在弹出的窗口中选择文件。
...
1. 单击 ![icon_menu](icon/icon_menu.svg) > **打印** 或使用快捷键 **Ctrl + P** 打开打印预览。
...
![toggle_case](jpg/d_toggle_case.png)
...
> ![tips](icon/tips.svg)窍门：选中一段文本后再进行查找，则这段文本会自动出现在查找窗口中。
...
![read_only](jpg/d_read_only.png)

![read_only](jpg/d_read_only02.png)
...
2. 在基础设置选项，您可以选择：
 - 设置字体样式和字号大小。
 - 勾选 **自动换行**，在编辑区自动换行。
 - 勾选 **代码折叠标志**，在左侧栏显示按钮 ![next](icon/next.svg) 或者 ![next](icon/next_down.svg) ，右键单击按钮选择折叠/展开当前层次或所有层次。
 - 勾选 **显示行号**，在左侧栏显示行号。
