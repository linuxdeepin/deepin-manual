...
- Select **Mark** to mark a certain line or a paragraph of texts. You can choose from 4 styles.
...
- Select **Mark All** to mark all the contents in Text Editor, or mark all the matching contents of selected texts in Text Editor. You can choose from 4 styles.
...
On the main menu, you can create [New Windows and tabs](#Create Files), search or replace contents, save files, switch window themes, view help manual and get more information about Text Editor.
