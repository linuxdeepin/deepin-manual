...
## 主界面
应用商店主界面由导航栏、搜索框、主菜单、首页轮播、排行榜、热门推荐、下载管理、应用更新和我的应用组成。
    ...
    <tbody>
        ...
        <tr>
         ...
         <tr>
            <td>3</td>
            <td>主菜单</td>
            <td>通过主菜单您可以清除缓存、查看帮助手册、关于信息、退出应用商店。</td>
        </tr>
        <tr>
            <td>4</td>
            <td>轮播区域</td>
...
## 应用管理
您可以通过应用商店搜索、下载、安装不同分类的应用，同时还可以根据轮播图、热门推荐、下载排行、用户评论等不同方式挖掘更多精彩应用。


### 搜索应用
1. 应用商店中自带搜索功能，单击搜索按钮![search](icon/search.svg)，输入关键字；

2. 输出关键字后，含该关键字的应用名称将在搜索栏下方显示，可查看包含该关键字的所有应用。
