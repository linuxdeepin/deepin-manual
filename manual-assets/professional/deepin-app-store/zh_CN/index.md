...
2. 如果当前应用需要购买，应用详情界面会显示购买金额。点击金额、购买。
...
2. 在 **我的应用** 界面，点击 **云端应用**，找到对应的应用，点击 **退款**。
...
4. 点击 **提交**，退款申请提交成功。一般2-3个工作日款项会退回到支付账户。
