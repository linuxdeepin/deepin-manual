    ...
    <tbody>
        ...
        <tr>
            ...
            <td>应用管理包括下载管理、应用更新及我的应用。
                <br/>下载管理主要显示当前下载任务，下载及安装进度，您还可以暂停和删除下载任务。
                <br/>在应用更新中，您可以查看待更新的应用，并选择是否更新。
                <br/>在我的应用中，您可以查看已安装的所有应用，卸载您不需要的应用。</td>
        </tr>
        <tr>
            <td>3</td>
            <td>搜索框</td>
            <td>您可以通过搜索框快速查找应用商店中的所有应用。</td>
        </tr>
         <tr>
            <td>4</td>
            <td>登录入口</td>
         ...
         <tr>
            <td>5</td>
            <td>主菜单</td>
            <td>在主菜单中您可以清除缓存、切换主题、查看帮助手册、关于信息、退出应用商店。</td>
        </tr>
        <tr>
   </tbody>
   </table>
...
2. 输入关键字，含该关键字的应用名称将在搜索栏下方显示，可查看包含该关键字的所有应用。

![1|Search](jpg/search.png)

## 应用管理

您可以通过应用商店下载、安装不同分类的应用，同时还可以根据轮播图、最新上架、装机必备、热门推荐、热门专题、下载排行、用户评论等不同方式挖掘更多精彩应用。
...
1. 登录您的Union ID，在应用商店界面选择 **我的应用**，单击 **云端应用**，即可看到该帐号下的全部云端应用。
...
<div class="version-info"><span>文档更新时间: 2021-01-15</span><span> 版本: 6.2</span></div>