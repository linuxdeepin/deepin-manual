...
1.  On App Store interface, hover the cursor over the cover or name of an application directly, click ![installhover](icon/installhover.svg). 
...
2. Select the remote applications you want to install and click ![installhover](icon/installhover.svg) .
...
On **My Apps** interface, click **Local Apps** to find the applications you want to uninstall, and click ![uninstall](icon/uninstall.svg).
...
<div class="version-info"><span>Update Date: 2022-01-13</span><span> Version: 6.2</span></div>