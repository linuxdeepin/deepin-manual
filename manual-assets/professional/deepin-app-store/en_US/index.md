...
## Search Applications
Input keywords to search applications.
...
You can search, download and install different categories of applications, and also, you can explore more splendid applications through slide show, new updates, essential applications, hot applications, recommendations, hot topics, rankings, user comments and other ways. 
...
2. Select the remote applications you want to install and click **Install**. 
...
On **My Apps** interface, click **Local Apps** to find the applications you want to uninstall, and click **Uninstall**.
...
<div class="version-info"><span>Update Date: 2021-08-10</span><span> Version: 6.2</span></div>