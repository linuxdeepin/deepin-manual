...
- 括号符号容错处理：输入左圆括号、右圆括号都会触发括号符号激活；
- 等于号 符号容错处理：输入 = (等于号)、按 **Enter** 键都会触发等于号符号激活；
...
- 历史表达式
  ...
  + 重新编辑：点击单条历史表达式，可重新编辑表达式，表达式显示在输入表达式区域 ，重新编辑后按键盘上的Enter键或=（等于），可修改历史表达式及联动表达式的数字结果。
...
- 重新编辑含有联动数字的表达式时，修改联动数字或联动数字的表达式错误时，联动解除，同时取消高亮显示数字。



## 主菜单

在主菜单中，您可以查看帮助手册，了解计算器的更多信息。
