...
> ![tips](icon/tips.svg)窍门：您可以右键单击字体文件并选择 **打开方式** > ![deepin-font-manager](icon/deepin-font-manager.svg)**字体管理器**，进入字体管理器界面，安装字体。
...
1. 在界面底部字体预览输入框中输入文本内容。
2. 左右拖动控制条设置字体大小。在字体集列表中查看字体显示效果。
...
5. 在所有字体列表中，也可以进行右键单击 **收藏** 或 **取消收藏** 操作。
> ![notes](icon/notes.svg)说明：既支持收藏/取消收藏单个字体，也支持批量收藏/取消收藏字体。


### 启用/禁用字体 

当您需要启用或者禁用字体时，可以使用字体管理器执行该操作。
...
![0|info](jpg/delete.png)


## 主菜单

在主菜单中，您可以查看帮助手册，了解字体管理器的更多信息。
