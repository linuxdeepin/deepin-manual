...
> ![tips](icon/tips.svg)：您可以右键点击字体文件并选择 **打开方式** > ![deepin-font-manager](icon/deepin-font-manager.svg)**字体管理器**，进入字体管理器界面，安装字体。
...
> ![notes](icon/notes.svg)：您可以打开 **控制中心** > **个性化** > **字体** 来设置 **标准字体**。
...
> ![notes](icon/notes.svg)：既支持导出单个字体，也支持批量导出字体。同一个字体仅导出最新版本，不存在副本，系统字体不能被导出。
...
> ![notes](icon/notes.svg)：既支持收藏/取消收藏单个字体，也支持批量收藏/取消收藏字体。
...
> ![notes](icon/notes.svg)：既支持启用/禁用单个字体，也支持批量启用/禁用字体。
...
> ![notes](icon/notes.svg)：既支持删除单个字体，也支持批量删除字体。系统字体不能删除。
