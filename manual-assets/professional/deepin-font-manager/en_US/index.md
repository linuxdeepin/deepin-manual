...
3. Input a name for the new document.
...
- Resume the renamed file/folder to the previous name(including extension name).
...
#### Advanced Search
1. In search bar, input the keywords and press **Enter**. Click ![filter](icon/filter.svg) icon to do advanced search.
...
You can create new window, [set share password](#Share Local Files),make settings, view manual and version information in Main Menu.
