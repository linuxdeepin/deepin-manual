...
- **文档中心**：单击 **文档中心** ，跳转至UOS产品网站，输入用户名和密码登录网站（如没有注册，则需要注册成功后才可以登录）。进入文档中心页面，即可查看相应文档。
...
<div class="version-info"><span>文档更新时间: 2020-08-24</span><span> 版本: 2.1</span></div>