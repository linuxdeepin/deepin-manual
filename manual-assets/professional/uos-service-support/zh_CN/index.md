...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到服务与支持图标![support](icon/support.svg)， 单击运行。
...
您还可以留下联系方式和咨询内容，以方便客服及时与您取得联系，快速解决问题。
...
<div class="version-info"><span>文档更新时间: 2021-01-15</span><span> 版本: 2.2</span></div>