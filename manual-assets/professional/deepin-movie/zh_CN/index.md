...
惬意的悠闲时光，让影院陪您一起度过！影院提供了直观易用的操作界面和丰富齐全的快捷键，依靠键盘就能完成所有的播放操作，让您彻底摆脱鼠标单击的束缚。您可以使用影院播放多种格式的视频文件。
...
>![notes](icon/notes.svg) 说明 ：当使用触控屏电脑时，在全屏状态下，一指向左滑动视频画面区域快退视频，一指向右滑动视频画面区域快进视频。
