...
2. 解锁手机 ，下拉手机通知栏，找到“正在通过USB充电”的通知并进入，将充电模式切换成“传输文件（MTP）”的模式。
3. 在手机中找到“设置”>“关于手机”>“版本号”，连续点击“版本号”直到弹出提示“开发者模式已启用”。  
   
   >![notes](icon/notes.svg)说明：开发者模式启用后，以后每次连接不需要再次点击版本号来启用，直接执行第4步操作即可。
4. 返回至“设置”，找到“开发者选项”并打开，找到”USB调试“并开启，此时手机端弹出需要授权的提示，点击“确定”完成授权。

![USB](jpg/USB.png) 

6. 手机端会弹出安装“UOS手机助手”的提示，请根据提示安装客户端手机助手，安装完成后方可在PC端进行操作。
...
1. 使用数据线将手机与PC端连接，并在PC端运行手机助手。
2. 解锁手机，手机端弹出“是否信任此电脑”的对话框，点击“信任”完成连接。
...
<div class="version-info"><span>文档更新时间: 2020-08-25</span><span> 版本: 5.1</span></div>