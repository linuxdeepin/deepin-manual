...
- Screen Capture will exit automatically after screenshot or screen recording completes.
...
You can do quick screenshots by the following ways:
...
- Use professional screenshot softwares to take screenshots, such as the Screen Capture software that comes with the operation system.
...
Full screen selection is used to identify the entire screen of the current display.
...
1.  Press ![ctrl](icon/Ctrl.svg)+![alt](icon/Alt.svg)+![A](icon/A.svg) on the keyboard to enter the screen capture mode.
2.  Move the cursor to the application window and the window will be selected automatically. The screenshot dimension will be displayed in the upper left corner. 
...
Customized area selection is used to drag the mouse to select the screenshot area freely.
...
1.  Press ![ctrl](icon/Ctrl.svg)+![alt](icon/Alt.svg)+![A](icon/A.svg) on the keyboard to enter the screen capture mode.
2.  Hold down and drag the left mouse button to select the screen capture area. Tthe screenshot dimension is displayed in the upper left. 
...
You can do fine tune the screenshot area. For example, you can enlarge or reduce the captured scope, move the screenshot among other functions. 
...
- Click: Click **Show Click** to display mouse and touchscreen during screen recording. Click it again to cancel display.
...
Click **Options** to expand the drop-down list in the **Screen Capture** toolbar. Select the options and you are able to record videos in GIG or MP4 format. You can also set the FPS.
