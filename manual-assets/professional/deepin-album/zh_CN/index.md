...
在相册界面上，点击底部的滚动条可以调整照片的缩略图大小。双击照片，或右键单击照片选择 **查看** ，进入看图界面。

![0|copy](jpg/navigation.png)
...
> ![tips](icon/tips.svg)窍门：滚动鼠标放大照片且当照片大小超出窗口范围时，会出现导航窗口。拖动导航窗口中的方框，查看该区域的信息。点击导航窗口右上角的 ![close_icon](icon/close_icon.svg) 按钮，关闭导航窗口；也可以右键单击照片，选择“隐藏导航窗口”。
...
在主菜单中，您可以[新建相册](#新建相册)、[导入照片](#导入照片)、查看帮助手册，了解相册的更多信息。
