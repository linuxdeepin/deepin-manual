...
2. 上下滚动鼠标滚轮浏览或通过搜索，找到相册 ![deepin-album](icon/deepin-album.svg)单击运行。
...
在相册界面，按下 **Ctrl + Shift + ?** 组合键来查看快捷键，熟练地使用快捷键，将大大提升您的操作效率。
...
3. 照片将会顺时针转旋转90°/逆时针旋转90°。
   ...
   > ![notes](icon/notes.svg)说明：当使用触摸屏电脑时，二指放置在照片上并保持一定距离，同时旋转二指来旋转照片。
   >
