...
1. 在设备管理器界面，单击 **打印机 **。
2. 界面显示连接的打印机列表，以及所有打印机的详细信息如名称、型号、制造商、设备RUI等信息。
...
其他设备包括非PCI的其他接口的输入设备，如键盘、光笔、手写板、数位板和游戏杆等设备。

![0|other device](jpg/other device.png)
