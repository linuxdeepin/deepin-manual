...
您可以在均衡器中调节音频质量，使其达到最佳的音效。

1. 在音乐界面，点击![icon_menu](icon/icon_menu.svg) 。
2. 点击 **均衡器**。
3. 开启 **均衡器** 后，自定义调节“前置放大”增益值和频率波段，将声音调至最佳后点击 **保存**，或者在模式的下拉框中选择一种音乐模式，系统会自动保存设置。
...
<div class="version-info"><span>文档更新时间: 2020-09-30</span><span> 版本: 6.0</span></div>