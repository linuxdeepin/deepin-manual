...
- 在音乐界面，如果界面中还没有音乐文件，点击**添加歌曲路径** 可以自定义选择本地的歌曲路径，批量添加歌曲文件。
...
2. 点击 **从播放队列中删除**，将该音乐文件从歌曲队列中删除，该音乐文件仍会保留在在本地文件夹中。
3. 点击 **从本地删除**，将该音乐文件从歌曲队列和本地文件夹中一并删除。
...
1. 在音乐界面，点击我的歌单右侧的 ![icon_plus](icon/icon_plus.svg) 。
2. 输入歌单的名称。
3. 按下键盘上的 **Enter** 键。
...
在主菜单中，您可以 [添加音乐](#添加音乐)、设置音乐信息、切换窗口主题、查看帮助手册，了解音乐的更多信息。
