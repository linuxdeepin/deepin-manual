...
2.   You can set text styles as follows:
   ...
   - Select your font style from the **Font** drop-down list.
   - Select regular font or bold font from the drop-down list.
   - Adjust the **Size** by entering a value manually or selecting a size from the drop-down list.
