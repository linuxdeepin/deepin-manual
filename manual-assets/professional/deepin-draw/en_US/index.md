...
2. Locate ![draw](icon/deepin_draw.svg) by scrolling the mouse wheel or searching "draw" in the Launcher interface.
...
1. On the Draw interface, click ![import](icon/Import_normal.svg)or  ![menu](C:/Users/Admin/Documents/aiwa/community/社区版1106/draw/en_US/icon/icon_menu.svg) > **Open**.
...
2. You can set the parameters for graphics as follows:
 ...
 - Click **Sides** to set sides for polygon graphics only. The number of sides ranges from 4 to 10, which can be adjusted by clicking the up or down arrow in **Sides** or entering the value manually.
...
4. Press the **Enter** key or click the ![check](icon/check.svg)icon to crop the graphics from the selected area.
