...
使用画板可以处理导入的图片，自由绘制图形，还可以导出多种图片格式。
...
3. 选择裁剪模式，选定需要裁剪的区域。
4. 按 **Enter** 键或单击属性栏上的![check](icon/check.svg)，将区域外的图形裁剪掉。
...
> ![notes](icon/notes.svg)说明：当使用触控屏电脑时，一指单击选中图片，手指按住 ![icon](icon/icon_rotate.svg) 自由旋转图片。
