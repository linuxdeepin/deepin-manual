...
> ![notes](icon/notes.svg)Notes: Package Installer will automatically detect your package. If the application has been installed locally, the prompt message "same version installed" or "other version installed" will be displayed. At this time, you can choose **Uninstall** or **Reinstall**.
