...
1. 运行授权管理工具有两种方式：
   ...
   - 点击右下角托盘上的 ![authorize1](icon/authorize1.svg)进入界面。
...
1. 点击右下角托盘上的 ![authorize1](icon/authorize1.svg)进入界面。

   ![0|probation1](jpg/probation1.png)

2. 点击 **试用期激活**，跳转到激活界面。

3. 点击 **立即激活**，会弹出二次确认弹框，点击 **确定**，弹出试用期激活成功界面，任务栏图标变为![authorize2](icon/authorize2.svg)。
...
![0|backup-recovery](jpg/backup-recovery.png)
...
在开机时，选择系统界面，点击 **UnionTech OS Backup & Restore**，进入统信UOS系统还原，用户可以选择“恢复统信UOS出厂设置”读取恢复出厂设置备份，也可以选择“恢复统信UOS历史备份”打开文件目录选取要还原的备份。
...
二指手势是针对操作系统和应用的窗口内容进行操作，包括移动、缩放、点击事件。
...
三指手势是针对操作系统和应用程序的窗口本身进行操作，包括移动、缩放、点击事件。
...
选中文本后，三指单击对应操作是小窗口快速翻译。

### 四指/五指手势

#### 显示/隐藏桌面

四指/五指向上或向下移动，显示/隐藏桌面， 对应 **Super** + **D** 快捷键。

#### 显示/隐藏启动器

四指/五指点击，显示/隐藏启动器， 对应 **Super** 快捷键。
