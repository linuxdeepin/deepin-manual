...
文档查看器具备基本的文件管理功能，可以执行打开、保存、打印文件，书签、注释等操作。
...
- 显示注释  
   ...
   ​      将鼠标悬停至高亮文本上，在出现的浮框中显示部分注释内容。

- 删除注释
   - 右键点击高亮文本，在菜单中选择取消高亮，可以取消文本高亮并同时删除注释。
...
通过缩略图可以进行文档缩略图目录![view](icon/view_normal.svg)、书签目录![view](icon/bookmark_normal.svg)、注释目录![view](icon/comments_normal.svg)的切换。手动拖拽目录边框，缩略图跟随可拖拽宽度大小的变化而变化。
...
1. 在文档查看器界面，打开一个文件。
2. 点击![view](icon/magnifier_normal_light.svg)。
...
1. 在文档查看器界面，点击![icon_menu](icon/icon_menu.svg)。
2. 点击 **在文件管理器中显示**，打开并定位该文件存放在文件夹位置。
