...
5. 若要正常使用新建分区，还需先格式化，再挂载，详细操作请参考 [分区格式化](#分区格式化) 和 [分区挂载](#分区挂载) 。
...
格式化分区后，将会删除该分区储存在磁盘上的所有数据，且无法撤销，请谨慎操作。
...
<div class="version-info"><span>文档更新时间: 2020-09-22</span><span> 版本: 1.1</span></div>