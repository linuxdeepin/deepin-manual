...
## 主界面
应用商店主界面由导航栏、搜索框、主菜单、首页轮播、热门推荐、排行榜、最新上架、专题专栏、下载管理、应用更新和我的应用组成。
...
### 下载/安装应用
应用商店提供一键式的应用下载和安装功能，无需手动处理。同时也支持云同步功能，您用Deepin ID登录后，下载安装的应用会同步显示在本地应用和云端应用。当在其他设备上登录该帐号时，可以一键安装云端应用。
...
> ![notes](icon/notes.svg)说明：未登录Deepin ID时，下载安装的应用仅会显示在本地应用中。
...
1. 登录您的Deepin ID后，选择 **我的应用**，单击 **云端应用**，即可看到该帐户下安装的全部云端应用。
