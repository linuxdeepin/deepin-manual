...
### 下载/安装应用
应用商店提供一键式的应用下载和安装，无需手动处理。支持网络帐号同步功能，您用网络帐号登录后，下载安装的应用会同步显示在本地应用和云端应用。当在其他设备上登录该帐号时，可以一键安装云端应用。
...
> ![notes](icon/notes.svg)说明：未登录网络帐号时，下载安装的应用仅会显示在本地应用中。
...
<div class="version-info"><span>文档更新时间: 2020-11-18</span><span> 版本: 6.2</span></div>