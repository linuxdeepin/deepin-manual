...
#### 高级搜索
1. 在搜索状态下，输入关键词后按 **Enter** 键，当搜索到结果时，搜索框右侧显示 ![filter](icon/filter.svg) 图标，点击该图标可进行高级搜索的操作。
...
2. 选择 **发送到** > **发送到蓝牙**。
3. 若电脑未连接蓝牙设备，在弹出的对话框中点击“前往蓝牙设置”，界面跳转至 **控制中心** > **蓝牙** 设置窗口，开启蓝牙功能，搜索附近蓝牙设备并连接，连接成功后，桌面上方弹出连接成功的提示。

4. 此时文件管理器界面弹出蓝牙文件传输的对话框，勾选接收设备，点击 **下一步**。
...
<div class="version-info"><span>文档更新时间: 2020-09-09</span><span> 版本: 5.2</span></div>