...
2. Click **Remove from playlist** to remove the music from the play queue, but the music file will be still on the local disk.
...
2. Right-click.
3. Select **Remove from playlist** to remove it from the playlist.
...
1.  On the Music interface, click ![menu](icon/icon_menu.svg) in the top right corner.
