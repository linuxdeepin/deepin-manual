...
- 添加注释
   ...
   > * 输入文本内容后，点击其他区域，注释内容自动保存，并且收缩成小图标的形式。
...
- 在文档查看器界面菜单栏，点击 “**+** ”放大或 “**-**” 缩小 。
   ...
   > ![notes](icon/notes.svg)说明：支持手动输入，工具栏缩略比例下拉框显示调整比例供选择：10%、25%、50%、75%、100%、125%、150%、175%、200%、300%、400%、500%。文档跟着比例依次放大缩小。
