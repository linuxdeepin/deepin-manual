    ...
    d.fn.orbit = function(a) {
        ...
        return this.each(function() {
            ...
            if (a.directionalNav) {
                ...
                c.append('<div class="slider-nav"><span id="Right" class="right" onMouseOver="this.className=\'right0\';document.getElementById(\'Left\').className=\'left0\'" onMouseOut="this.className=\'right\';document.getElementById(\'Left\').className=\'left\'">Right</span><span class="left" id="Left" onMouseOver="this.className=\'left0\';document.getElementById(\'Right\').className=\'right0\'" onMouseOut="this.className=\'left\';document.getElementById(\'Right\').className=\'right\'">Left</span></div>');
