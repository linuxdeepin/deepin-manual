    ...
    d.fn.orbit = function(a) {
        ...
        return this.each(function() {
            ...
            if (a.directionalNav) {
                ...
                c.append('<div class="slider-nav"><span id="Right" class="right" onMouseOver="this.className=\'right0\';" onMouseOut="this.className=\'right\';">Right</span><span class="left" id="Left" onMouseOver="this.className=\'left0\';" onMouseOut="this.className=\'left\';">Left</span></div>');
            ...
            if (a.bullets) {
                c.append('<div class="orbit-bullets"><ul style="width: 200px;text-align: center;padding: 0; margin: 7px 0;"></ul></div>');
                var C = c.children("div.orbit-bullets").children("ul")
                for (i = 0; i < p; i++) {
                    k = d("<li>" + (i + 1) + "</li>");
